...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/azure-app-service/)
...
```bash
kubectl port-forward deployment/tp-azure-app-service 8080:8080
```
...
```bash
kubectl run load-generator --image=busybox --restart=Never -- /bin/sh -c "while true; do wget -q -O- http://tp-azure-app-service; done"
```

#### 14. Project Structure
```text
tp-tp-azure-app-service/
...
# Primary Config File: webapp_config.tf
```
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/azure-app-service/) |
